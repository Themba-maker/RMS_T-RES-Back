...
router.post('/InsertStuIssues/', (req,res)=>{
    ...
    student_no:req.body.student_no,
    landlord_email:"charlse@gmail1.com",
  
   }


   
   db.query('INSERT INTO stu_issues SET ? ',[ issueData],function (error, results, fields)
{
...
router.post('/landlodImage/',upload.single('avatar'), (req,res)=>{
 console.log(req.file);
    ...
    avatar:"http://192.168.43.92:9000/"+req.file.path
